...
/// haz una pantalla de inicio de sesion que pida el correo electronico, como
/// la contraseña
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          _model.usuario = await actions.iniciarSesionUsuario(
                            _model.textController1.text,
                            _model.textController2.text,
                          );
                          FFAppState().usuario =
                              UsuarioStruct.maybeFromMap(_model.usuario!)!;
                          safeSetState(() {});
                          if (UsuarioStruct.maybeFromMap(_model.usuario)?.rol ==
                              'admin') {
